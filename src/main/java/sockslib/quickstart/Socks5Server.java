...
public class Socks5Server {
    ...
    public void start(@Nullable String[] args) throws IOException {
        ...
        try {
            ...
            initThreadPool(arguments, builder);
    ...
    public void showHelp() {
        ...
        System.out.println("  -c, --connections <val>      Server max connections(Each uses a thread)");
        System.out.println("  -b, --buffer_size <val>       Server buffer for each thread");
    ...
    private void initThreadPool(Arguments arguments, SocksServerBuilder builder) throws
            IllegalArgumentException {
        int threads = arguments.getIntValue(Arrays.asList("-c", "--connections"), 1024);
        builder.setExecutorService(Executors.newFixedThreadPool(threads));
        int bufferSize = arguments.getIntValue(Arrays.asList("-b", "--buffer_size"), 1024 * 1024);
